export const kanjiByGrade = [
  {
    ...
    items: [
      ...
      { char: '空', kunyomi: 'そら', onyomi: 'クウ', meaning: 'そら', strokes: 8, hint: 'ウに穴', story: '青く広がる空。', example: '青空', gameType: 'airplane', gameConfig: { title: '空の旅', instruction: '飛行機で「空」を集めよう！', targetChar: '空', badChar: '穴', bg: '#81d4fa' } },
      ...
      { char: '天', kunyomi: 'あま', onyomi: 'テン', meaning: 'てん', strokes: 4, hint: '大に一', story: '天まで届け。', example: '天才', gameType: 'airplane', gameConfig: { title: '天まで届け', instruction: '「天」を集めて高く飛ぼう！', targetChar: '天', badChar: '夫', bg: '#b3e5fc' } },
